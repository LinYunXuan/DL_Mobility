...
log_file = os.path.join('../logs/logFNN2', datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S"))
tensorboard_callback = TensorBoard(log_file)
checkpoint_file = "../logs/logFNN2/best_model_FNN"+datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")+".hdf5"
